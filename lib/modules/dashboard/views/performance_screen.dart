                        ...
                        children: [
                          Expanded(
                            child: PerformanceBox(
                              ...
                              title: "Total Orders",
                              value: "${ordersController.riderStatsModel?.totalOrders}",
                          ...
                          Expanded(
                            child: PerformanceBox(
                              ...
                              value: "${ordersController.riderStatsModel?.totalDistance}km",
                              gradient: const LinearGradient(
                                colors: [
                                  Color(0xFFE3EDFF),
                                  Color(0xFFFFFFFF),
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          customText(formatToCurrency(double.parse(ordersController.riderStatsModel?.totalDistance.toString()??"0")??0),
                              color: AppColors.blackColor,
