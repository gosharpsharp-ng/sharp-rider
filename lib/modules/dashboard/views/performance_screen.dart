import 'package:gorider/modules/dashboard/views/widgets/delivery_history_widget.dart';
                  ...
                  children: [
                        ...
                        children: [
                          Expanded(
                            child: PerformanceBox(
                              ...
                              gradient: const LinearGradient(
                                colors: [Color(0xFFFFF6E3), Color(0xFFFFFFFF)],
                          ...
                          Expanded(
                            child: PerformanceBox(
                              ...
                              gradient: const LinearGradient(
                                colors: [Color(0xFFE3EDFF), Color(0xFFFFFFFF)],
                                begin: Alignment.topRight,
                                end: Alignment.bottomLeft,
                              ),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        gradient: const LinearGradient(
                          colors: [Color(0xFFE7FFE3), Color(0xFFFFFFFF)],
