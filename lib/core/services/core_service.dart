...
import 'package:gorider/core/services/models/api_response.dart';

import '../routing/app_pages.dart';
import '../utils/exports.dart' show GetConnect, GetStorage, showToast, Get;
      ...
      dio_pack.InterceptorsWrapper(
        ...
        onError: (DioException error, handler) {
          ...
          if (error.response?.statusCode == 404 ||
            ...
            String fullUrl =
                '${_dio.options.baseUrl}${error.requestOptions.path}';
