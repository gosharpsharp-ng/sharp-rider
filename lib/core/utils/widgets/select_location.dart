...
import 'package:gorider/core/models/location_model.dart';
...
class _SelectLocationState extends State<SelectLocation> {
  ...
  LatLng initialPosition =
      const LatLng(9.0820, 8.6753); // Default: Abuja, Nigeria
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
        children: [
          // Show loading placeholder while map is initializing
          if (!_isMapReady)
            Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color:
                            AppColors.obscureTextColor.withOpacity(0.1),
